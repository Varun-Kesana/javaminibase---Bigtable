...
public class NestedLoopsJoinsMaps implements IStream {
    private AttrType _in1[], _in2[];
    private int in1_len, in2_len;
    private IStream outer;
     ...
     */
    public NestedLoopsJoinsMaps(AttrType in1[],
                            int len_in1,
                            short t1_str_sizes[],
                            AttrType in2[],
                            int len_in2,
        ...
        nOutFlds = n_out_flds;
        try {
            // TODO: check if in2 should be passed
            t_size = MapUtils.setup_op_tuple(joined_map, Jtypes,
    ...
    public Map getNext()
        ...
        do {
            ...
            if (get_from_outer == true) {
                ...
                if ((outer_map = outer.getNext()) == null) {
                    done = true;
                    if (inner != null) {
            ...
            while ((inner_map = inner.getNext(mid)) != null) {
                inner_map.setMapHeader(_in2, t2_str_sizescopy);
                if (PredEval.Eval(RightFilter, inner_map, null, _in2, null)) {
                    // outer_map - left table Stream (column filter)
                    // inner_map - right table heap (scanning all)
     ...
     */
    public void closeStream() throws JoinsException, IOException, IndexException {
//        if (!closeFlag) {
            try {
                outer.closeStream();
            } catch (Exception e) {
