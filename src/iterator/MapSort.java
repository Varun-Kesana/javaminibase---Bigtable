...
public class MapSort extends MapIterator implements GlobalConst {
     ...
     */
    public MapSort(AttrType[] attrTypes,
                   short[] field_sizes,
                   MapIterator am,
                   int sort_fld,
        ...
        try {
            tempMap.setMapHeader(BigTableMain.BIGT_ATTR_TYPES, BigTableMain.BIGT_STR_SIZES);
        } catch (Exception e) {
...
//        for (int k = 0; k < _num_pages; k++) bufs[k] = new byte[MAX_SPACE];
        ...
        try {
            ...
            op_map_buf.setMapHeader(BigTableMain.BIGT_ATTR_TYPES, BigTableMain.BIGT_STR_SIZES);
        } catch (Exception e) {
     ...
     *
     * @return the next map, null if all tuples exhausted
    ...
    private int generate_runs(int max_elems, AttrType sortFldType, int sortFldLen) throws Exception {
        ...
        try {
            lastElem.setMapHeader(BigTableMain.BIGT_ATTR_TYPES, BigTableMain.BIGT_STR_SIZES);
    ...
    */
        ...
        if (!i_buf[cur_node.run_num].empty()) {
            ...
            try {
                ...
                newMap.setMapHeader(BigTableMain.BIGT_ATTR_TYPES, BigTableMain.BIGT_STR_SIZES);
