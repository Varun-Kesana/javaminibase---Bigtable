   ...
   */
    ...
    */
    ...
    /* Internal HeapFile function (used in getRecord and updateRecord):
       ...
       If the user record cannot be found, return false.
    */
    private boolean _findDataPageMap(MID mid, PageId dirPageId, HFPage dirpage, PageId dataPageId, HFPage datapage, RID rpDataPageRid)
    throws Exception {
        PageId currentDirPageId = new PageId(_firstDirPageId.pid);
        ...
        while (currentDirPageId.pid != INVALID_PAGE) {
            ...
            try {
                ...
                throw new HFException(e, "unpin of current directory page failed");
            }
    ...
    /**
     * Insert record into file and return its mid
     *
